...
public class TwoOptSolver {
    ...
    public void towOptForNonIntersectingEdges() {
        ...
        while (numberOfLoopsNotEdit < tourSubgraphMask.edgeSet().size() ) {
    ...
    private void solveEdgeCrossing(ModifiedWeightedEdge edge1, ModifiedWeightedEdge edge2) {
