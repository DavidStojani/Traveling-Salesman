...
public class TriangleSoup {
    ...
    private final List<Triangle2D> triangleSoup;
     ...
     */
    public TriangleSoup() {
        triangleSoup = new ArrayList<Triangle2D>();
    }
     ...
     */
    public Triangle2D findContainingTriangle(Point2D point) {
     ...
     */
    public Edge2D findNearestEdge(Point2D point) {
     ...
     */
    public void removeTrianglesUsing(Point2D vertex) {
